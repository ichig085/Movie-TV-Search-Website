        ...
        $.getJSON(servicePoint, function (jsonData) {
            ...
            if (isMultiSearch || jsonData.results.hasOwnProperty("media_type")) {
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    videoOrPersonDiv = "<div class='book'>";
            ...
            $(".movieID").on('click', function () { getVideoOrPersonDetail($(this).attr("id")); });

        });
    }

    function getVideoOrPersonDetail(movieID) {
        ...
        if (multi_media_type[movieID] == "tv" || isDiscoverTV) {
            ...
            console.log('this the bitch being called and fucking it');
            ...
            console.log("this was called for disc movie cast bitch")

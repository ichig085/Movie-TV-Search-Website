$(document).ready(function () {
    ...
    var radioValue = "";
    var url = "https://api.themoviedb.org/3/trending/movie/day?api_key=596a559ed3e4a3408502d51411f3d607&page=1";
    var multi_media_type = {};
    var getPerson = false;
    var isDiscoverMovie = false;
    var isDiscoverTV = false;
    sessionStorage.setItem("url1", `https://api.themoviedb.org/3/trending/movie/day?api_key=596a559ed3e4a3408502d51411f3d607&page=`);
    ...
    function searchBooks(servicePoint) {
        ...
        if (servicePoint.includes("/multi")) {
            isMultiSearch = true;
        }
        $("#listLayout").show();
        $("#gridLayout").show();

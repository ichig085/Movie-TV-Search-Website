        ...
        $.getJSON(servicePoint, function (jsonData) {
            ...
            if (isMultiSearch || jsonData.results.hasOwnProperty("media_type")) {
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    videoAnd = "<div class='book'>";
                    videoAnd += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    videoAnd += "<h3 style='padding:3%;'>" + title + "</h3>";
                    videoAnd += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;
                    $("#results").append(videoAnd);
                }
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    videoAnd = "<div class='book'>";
                    videoAnd += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    videoAnd += "<h3 style='padding:3%; margin-bottom: 0;'>" + title + "</h3>";
                    videoAnd += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;

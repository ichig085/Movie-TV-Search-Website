        ...
        $.getJSON(servicePoint, function (jsonData) {
            ...
            if (isMultiSearch || jsonData.results.hasOwnProperty("media_type")) {
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    video = "<div class='book'>";
                    video += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    video += "<h3 style='padding:3%;'>" + title + "</h3>";
                    video += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    video = "<div class='book'>";
                    video += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    video += "<h3 style='padding:3%; margin-bottom: 0;'>" + title + "</h3>";
                    video += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;

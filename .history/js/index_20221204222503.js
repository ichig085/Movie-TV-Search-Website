                    ...
                    if (jsonData.hasOwnProperty("biography")) {
                        if (jsonData.biography == "") {
                            ...
                            for (var i = 0; i < jsonData.biography.length; i++) {
                                ...
                                console.log(jsonData.biography.charAt(i + 2) === jsonData.biography.charAt(i + 2).toUpperCase())
                                if (jsonData.biography.charAt(i) == "." && isCharBefore == true && isCharAfter == true && isCharAfter2 == true && jsonData.biography.charAt(i + 2) === jsonData.biography.charAt(i + 2).toUpperCase()) {
                                    continue;
                                }
                                else {

                    ...
                    if (jsonData.hasOwnProperty("biography")) {
                        if (jsonData.biography == "") {
                            ...
                            for (var i = 0; i < jsonData.biography.length; i++) {
                                ...
                                var isCharAfter3 = /^[a-zA-Z]+$/.test(jsonData.biography.charAt(i + 4));
                                var isCharAfter4 = /^[a-zA-Z]+$/.test(jsonData.biography.charAt(i + 2));
                                
                                // console.log(isChar)
                                if (jsonData.biography.charAt(i) == "." && isCharBefore == true && isCharAfter == true && isCharAfter2 == true && isCharAfter3 == true && isCharAfter2 == true) {
                                    continue;
                                }
                                else {

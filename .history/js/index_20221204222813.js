                    ...
                    if (jsonData.hasOwnProperty("biography")) {
                        if (jsonData.biography == "") {
                            ...
                            for (var i = 0; i < jsonData.biography.length; i++) {
                                ...
                                console.log(jsonData.biography.charAt(i + 3) === jsonData.biography.charAt(i + 3).toUpperCase())
                                if (jsonData.biography.charAt(i) == "." && isCharBefore == true && isCharAfter == true && isCharAfter2 == true && jsonData.biography.charAt(i + 3) === jsonData.biography.charAt(i + 3).toUpperCase()) {
                                    continue;
                                }
                                else if (jsonData.biography.charAt(i) == "." && !jsonData.biography.charAt(i + 2) === jsonData.biography.charAt(i + 2).toUpperCase()) {
                                    console.log(break_paragraph);
                                    break_paragraph++;

                                }
                                if (break_paragraph % 4 == 0 && jsonData.biography.charAt(i) == ".") {
                                    console.log("period count equals ", break_paragraph);
                                    biography += "<br><br>";
                                }
                            }
                        }

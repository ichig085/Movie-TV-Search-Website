                    ...
                    if (jsonData.hasOwnProperty("biography")) {
                        if (jsonData.biography == "") {
                            ...
                            for (var i = 0; i < jsonData.biography.length; i++) {
                                ...
                                var isCharAfter1 = /^[a-zA-Z]+$/.test(jsonData.biography.charAt(i + 2));
                                var isCharAfter2 = /^[a-zA-Z]+$/.test(jsonData.biography.charAt(i + 3));

                                // console.log(isChar)
                                if (jsonData.biography.charAt(i) == "." && isCharBefore == true && isCharAfter == true && isCharAfter1 == true && isCharAfter2 == true) {
                                    continue;
                                }
                                else {

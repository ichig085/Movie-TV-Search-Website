        ...
        try {
            ...
            $.getJSON(url, function (jsonData) {
                ...
                if (sessionStorage.getItem("media_type") == "person" || sessionStorage.getItem("name") != null || multi_media_type[movieID] == "person") {
                    ...
                    movie = `<div class='div11'><img src='${image}' style='width: 100%; height: auto;'/><h3>Personal Info</h3><p class='personalInfo' style='font-weight:bold; margin-bottom:0; font-size: 1rem'>Known For</p><p style='margin-top:.25rem; font-size: .90rem;'>${known_for}</p><p class='personalInfo' style='font-weight:bold; margin-bottom:0; font-size: 1rem'>Gender</p><p style='margin-top:.25rem; font-size: .90rem;'>${gender}</p><p class='personalInfo' style='font-weight:bold; margin-bottom:0; font-size: 1rem'>Birthday</p><p style='margin-top:.25rem; font-size: .90rem;'>${birthday}</p><p class='personalInfo' style='font-weight: bold; margin-bottom:0; font-size: 1rem'>Place of Birth</p><p style='margin-top:.25rem; font-size: .90rem;'>${place_of_birth}</p><p class='personalInfo' style='font-weight:bold; margin-bottom:0; font-size: 1rem'>Also Known As</p>${also_known_as}</div>`

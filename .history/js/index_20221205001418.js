        ...
        $.getJSON(servicePoint, function (jsonData) {
            ...
            if (isMultiSearch || jsonData.results.hasOwnProperty("media_type")) {
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    videoAndP = "<div class='book'>";
                    videoAndP += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    videoAndP += "<h3 style='padding:3%;'>" + title + "</h3>";
                    videoAndP += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;
                    $("#results").append(videoAndP);
                }
                ...
                for (i = 0; i < jsonData.results.length; i++) {
                    ...
                    videoAndP = "<div class='book'>";
                    videoAndP += `<img style='cursor:pointer' class='movieID' id='${jsonData.results[i].id}' src='` + image + "' />";
                    videoAndP += "<h3 style='padding:3%; margin-bottom: 0;'>" + title + "</h3>";
                    videoAndP += `<p style="padding: 3%; margin-top: 1rem;">Rating: ${vote_average}</p></div>`;

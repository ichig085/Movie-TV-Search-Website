...
// Save initial URLs to session storage
...
// Click event for multi search button
$("#button1").click(function () {
    ...
    isDiscoverTV = false;
    // Remove session storage values if present
...
// Click event for "discover movies" button
$("#movies").click(function () {
    ...
    // Get user's safe search choice
    var isAdult = $("input[name='safeSearch']:checked").val();
    // Construct URL for movie discovery
...
// Click event for "discover TV" button
$("#tv").click(function () {
    // Hide trending content
    $(".trending").hide();
    // Clear containers
    ...
    // Get user's safe search choice
    var isAdult = $("input[name='safeSearch']:checked").val();
    // Construct URL for TV show discovery
